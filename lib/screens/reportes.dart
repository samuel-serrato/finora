...
import 'package:finora/helpers/pdf_exporter.dart';
...
class _ReportesScreenState extends State<ReportesScreen> {
 ...
 Future<void> obtenerReportes() async {
  ...
  try {
    ...
    String tipoReporte = selectedReportType == 'Reporte Contable' 
        ? 'contable' 
        : 'general';
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 15),
          ElevatedButton(
  onPressed: (selectedReportType != null && selectedDateRange != null)
      ? () {
          print('Tipo de reporte seleccionado: $selectedReportType'); // Depuración
          obtenerReportes();
        }
      : null,
